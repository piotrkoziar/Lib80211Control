...
Interface::Interface(const uint32_t &id)
    : Entity(),
      ...
      name_(&get_attributes(name_), NL80211_ATTR_IFNAME,
            Attribute::ValueTypes::STRING, NL80211_CMD_GET_INTERFACE,
            NL80211_CMD_SET_INTERFACE),
      type_(&get_attributes(type_), NL80211_ATTR_IFTYPE,
            Attribute::ValueTypes::UINT32, NL80211_CMD_GET_INTERFACE,
            NL80211_CMD_SET_INTERFACE),
      mac_addr_(&get_attributes(mac_addr_), NL80211_ATTR_MAC,
                Attribute::ValueTypes::UINT48, NL80211_CMD_GET_INTERFACE,
                NL80211_CMD_SET_INTERFACE),
      ssid_(&get_attributes(ssid_), NL80211_ATTR_SSID,
            Attribute::ValueTypes::STRING, NL80211_CMD_GET_INTERFACE,
            NL80211_CMD_SET_INTERFACE) {
  set_identifier(id);
}
